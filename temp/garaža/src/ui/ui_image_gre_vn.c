...
#ifndef LV_ATTRIBUTE_IMG_IMG_GRE_VN
#define LV_ATTRIBUTE_IMG_IMG_GRE_VN
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMG_GRE_VN uint8_t img_gre_vn_map[] = {
